...
const ClobCard: React.FC<ClobCardProps> = ({ market }) => {
  return (
    <Link
      href={market.href}
      className="group relative flex flex-col justify-between h-48 p-4 rounded-lg border border-gray-800 bg-black hover:bg-gray-900 transition-all duration-300"
    >
